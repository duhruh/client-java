...
- API version: version not set
  - Build date: 2019-05-14T11:45:09.912-07:00[America/Los_Angeles]
...
```xml
<dependency>
  <groupId>com.github.duhruh</groupId>
...
```groovy
compile "com.github.duhruh:client-java:v1beta1"
```
...
* `target/client-java-v1beta1.jar`
* `target/lib/*.jar`
