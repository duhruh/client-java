...
public class GrafeasV1Beta1Api {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createNoteCall(V1beta1Note body, String parent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createNoteValidateBeforeCall(V1beta1Note body, String parent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        com.squareup.okhttp.Call call = createNoteCall(body, parent, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public V1beta1Note createNote(V1beta1Note body, String parent) throws ApiException {
        ApiResponse<V1beta1Note> resp = createNoteWithHttpInfo(body, parent);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V1beta1Note> createNoteWithHttpInfo(V1beta1Note body, String parent) throws ApiException {
        com.squareup.okhttp.Call call = createNoteValidateBeforeCall(body, parent, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createNoteAsync(V1beta1Note body, String parent, final ApiCallback<V1beta1Note> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createNoteValidateBeforeCall(body, parent, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V1beta1Note>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateNoteCall(V1beta1Note body, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateNoteValidateBeforeCall(V1beta1Note body, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        com.squareup.okhttp.Call call = updateNoteCall(body, name, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public V1beta1Note updateNote(V1beta1Note body, String name) throws ApiException {
        ApiResponse<V1beta1Note> resp = updateNoteWithHttpInfo(body, name);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V1beta1Note> updateNoteWithHttpInfo(V1beta1Note body, String name) throws ApiException {
        com.squareup.okhttp.Call call = updateNoteValidateBeforeCall(body, name, null, null);
        Type localVarReturnType = new TypeToken<V1beta1Note>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateNoteAsync(V1beta1Note body, String name, final ApiCallback<V1beta1Note> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateNoteValidateBeforeCall(body, name, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V1beta1Note>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
