...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-14T11:45:09.912-07:00[America/Los_Angeles]")public class V1beta1BatchCreateNotesRequest {
  ...
  * @return parent
  **/
  @Schema(description = "The name of the project in the form of `projects/[PROJECT_ID]`, under which the notes are to be created.")
  ...
  * @return notes
  **/
  @Schema(description = "The notes to create. Max allowed length is 1000.")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(parent, notes);
  }
