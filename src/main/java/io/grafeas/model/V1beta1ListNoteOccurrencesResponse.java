...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-14T11:00:24.051-07:00[America/Los_Angeles]")public class V1beta1ListNoteOccurrencesResponse {
  ...
  * @return occurrences
  **/
  @Schema(description = "The occurrences attached to the specified note.")
  ...
  **/
  @Schema(description = "Token to provide to skip to a particular spot in the list.")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(occurrences, nextPageToken);
  }
