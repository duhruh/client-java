 ...
 */
@Schema(description = "Response for listing occurrences.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-05-14T11:23:37.921-07:00[America/Los_Angeles]")public class V1beta1ListOccurrencesResponse {
  ...
  * @return occurrences
  **/
  @Schema(description = "The occurrences requested.")
